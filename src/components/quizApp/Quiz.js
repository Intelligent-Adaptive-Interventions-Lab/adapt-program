...
import codingQuestion from "./question2.json"
...
const Quiz = ({
    ...
    const data = codingQuestion["set1"][0];
    ...
    if (currentQuestion === questions.length && quizPhase === "train") {
        return (
            <div>
                <div className="training-finished">
                    <h2>Congratulations! You have completed the practice
                        problems.</h2>
                </div>
                {!showTestButton && (
                    <div className="tetris-container" style={WRAPPER_STYLE}>
                        <h4>To give yourself a break before moving on to the
                            test problems, you have 1 minute to play Snake.</h4>
                        <h3>Remaining time : {countdown} seconds</h3>
                    </div>
                )}
                {showTestButton && (
                    <button onClick={onStartTest}>Continue to test
                        problems</button>
                )}
            </div>
        );
        ...
        return (
            <div className="test-finished">
                <h2>Congratulations, you are almost done! Please click below for
                    a short survey before completing the HIT.</h2>
                <button onClick={() => setCurrentPage("survey")}>Continue to
                    survey
                </button>
            </div>
        )
                    ...
                    <div className='col-6'>
                        <div className='d-flex flex-column'>
                            <div className='p-0'>
                                ...
                                {false ? (
                                    <div className='container p-0'>You scored 1
                            ...
                            <div className='pt-2'>
                                ...
                                <ul className="nav nav-tabs" id="myTab"
                                    ...
                                    <li className="nav-item"
                                        role="presentation">
                                        <button
                                            className="nav-link active rounded-bottom-0 fw-bold"
                                            id="results-tab"
                                            data-bs-toggle="tab"
                                    ...
                                    <li className="nav-item me-auto"
                                        role="presentation">
                                        <button
                                            className="nav-link rounded-bottom-0 fw-bold"
                                            id="testcases-tab"
                                            data-bs-toggle="tab"
                                            data-bs-target="#testcases"
                                            type="button" role="tab"
                                            aria-controls="testcases"
                                            aria-selected="false">Test cases
                                        </button>
                                    </li>
                                ...
                                <div className="tab-content">
                                    <div className="tab-pane active"
                                         id="results" role="tabpanel"
                                         aria-labelledby="results-tab"
                                         tabindex="0">
                                        <OutputWindow
                                            outputDetails={outputDetails}/>
                                    </div>
                                    <div className="tab-pane" id="testcases"
                                         role="tabpanel"
                                         aria-labelledby="testcases-tab"
                                         tabindex="0">
                                        <div
                                            className='card p-0 m-0 col-12 border border-top-0 border-white bg-black rounded-top-0'>
                                            <br/><br/>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className='col-6'>
                        ...
                        <div className='pt-2'>
                            <div className='container text-white'>
                                ...
                                <h1>{data.title}</h1>
                                <p>{data.rules.join('<br>')}</p>
                                <h2>Function Signature:</h2>
                                <pre><code>{data.functionSignature}</code></pre>
                                <h2>Parameters:</h2>
                                <ul>
                                    <li>{data.parameters.join('</li><li>')}</li>
                                </ul>
                                <h2>Returns:</h2>
                                <p>{data.returns}</p>
                                <h2>Examples:</h2>
                                <pre><code>{data.examples.join('\n')}</code></pre>
                            </div>
                        </div>
                    </div>
                </div>
